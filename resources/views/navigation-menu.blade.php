    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-1 ml-3 ">
                    ...
                    <div class="dropdown inline-block relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
                            <li class=""><a class=" bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Arabic</a></li>
                            <li class=""><a class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">English</a></li>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @endif
                @if(Auth::user()->role==1)
                <button class="bg-blue-400 hover:bg-blue-200 focus:outline-none text-white font-bold py-2 px-4 rounded "><a href="/project/create">Add projects</a></button>
                @endif
                <!-- Settings Dropdown -->
                <div class="ml-3 relative">
